...
- `src/engine/` y los agentes (`src/coordinators/`, `src/masters/`, `src/phone/`, `src/triage/`): el motor y el runner, en este mismo paquete. Los registros se escriben en `runs/` y los mapas se leen de `data/`.
