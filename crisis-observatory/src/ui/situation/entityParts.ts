import { sceneLabel, type Attention, type IncidentFrame, type SceneFrame } from "../engineTrace";

// Words and icons for the selection's detail modal. Icons are Lucide paths (ISC).
...
/** What the callers said happened; a siren while nobody has said. */
export const incidentIcon: Record<SceneFrame["kind"] | "unknown", string> = {
  vehicle_trapped: svg(
  ...
  building_collapse: svg(
    '<path d="M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z"/><path d="M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2"/><path d="M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-2"/><path d="M10 6h4"/><path d="M10 10h4"/><path d="M10 14h4"/><path d="M10 18h4"/>',
  ),
  // "Persona desplomada": someone who collapsed, a medical case, not a building.
  collapse: svg(
...
export const attentionText: Record<Attention, string> = {
  waiting: "sin atender",
  attended: "atendida",
  resolved: "resuelta",
};
/** Sentence case for the engine's lower-case labels. */
export const capitalize = (s: string) => s.charAt(0).toLocaleUpperCase("es") + s.slice(1);
export const incidentWhat = (i: IncidentFrame) =>
  i.mechanism ? sceneLabel(i.mechanism.value) : "qué ha pasado, sin confirmar";
/** A hospital's name without the word everybody already reads from the icon. */
export const hospitalName = (name: string) => name.replace(/^Hospital\s+/i, "");
